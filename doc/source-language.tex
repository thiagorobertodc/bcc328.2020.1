...
semânticas.
% \begin{center}
%   \includegraphics[width=.4\textwidth]{trivia.jpeg}
% \end{center}
...
\begin{gramatica}
  \begin{synshorts}
    ...
    \begin{tabular}{r@{$\;\rightarrow\;$}l>{\bfseries}r}
      ...
      <Exps>    & <Exp> <Exps>                         & lista de argumentos     \\
      <Exps>    & <Exp> "," <Exps>                     &                         \\
    \end{tabular}
    \end{mdframed}
  \end{synshorts}
...
ferramentas e bibliotecas externas, entre as quais:
\begin{description}
  \item[ocamllex] Ocamllex é um gerador de analisador léxico. Ele produz
  um analisadores léxicos (em OCaml) a partir de conjuntos de
